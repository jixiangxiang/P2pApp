...
public class ORechargeRecordActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String[] types = new String[]{"全部", "成功", "未成功"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orecharge_record);
    }

    @Override
    protected void initView() {
        initialize();
        initTitleText(getString(R.string.title_activity_orecharge_record), BaseActivity.TITLE_CENTER);
        ...
        baseAdapter = new EBaseAdapter(this, fundsRecordBeans, R.layout.list_funds_item,
                new String[]{"amt", "order", "date", "status"},
                new int[]{R.id.fundsType, R.id.addFunds, R.id.deleteFunds, R.id.fundsTime});
        fundsList.setAdapter(baseAdapter);

        request = new StringRequest(Request.Method.POST, ApiUtils.FROZREC, this, this) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> map = new HashMap<>();
                map.put("type", String.valueOf(type));
                map.put("page", String.valueOf(page));
                map.put("sign", SPUtils.getString(ORechargeRecordActivity.this, "sign"));
                return map;
            }
        };
