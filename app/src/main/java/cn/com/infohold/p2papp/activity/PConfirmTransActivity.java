...
public class PConfirmTransActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v == confirmTransBtn) {
            ...
            params.put("actualAssignPrice", String.valueOf(Double.valueOf(data.getString("remain_principal"))
                    + Double.valueOf(data.getString("accrued_interest")) - Double.valueOf(StringUtils.isEmpty(transMoney) ? "0" : transMoney)));
