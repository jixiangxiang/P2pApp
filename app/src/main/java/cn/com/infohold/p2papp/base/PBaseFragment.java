...
public class PBaseFragment extends Fragment implements Response.Listener, Response.ErrorListener {
    ...
    public void onErrorResponse(VolleyError error) {
        ...
        //((PBaseActivity) getActivity()).alertDialog(error.toString(), null);
    }
    ...
    public void onResponse(Object response) {
        ...
        if (StringUtils.isEquals(result.getCode(), ApiList.REQUEST_SUCCESS)) {
            ...
            //((PBaseActivity) getActivity()).alertDialog(result.getMsg(), null);
        }
    }
