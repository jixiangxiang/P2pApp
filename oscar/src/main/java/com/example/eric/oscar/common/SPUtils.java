...
//	private static final String SHARED_PREFERENCES_BANK = "oscar";

//	private static final String SHARED_PREFERENCES_INTERFACE = "interface";

    private static final String SHARED_PREFERENCES_XML_PARSE_CONSTANTS = "constants";
    private static final String SHARED_PREFERENCES_XML_PARSE_PACKAGE = "shared_package";
    ...
    public static void setString(Context context, String key, String value) {
        ...
        Log.i("interface", "interface getString convertValue--->" + convertValue + "key-->" + key);
        SharedPreferences sp = context.getSharedPreferences(getShareName(context),
    ...
    public static void addData(Context context, String key, String value) {
        String convertValue = convert(value, true);
        Log.i("DemoTest", "addData convertValue--->" + convertValue + "key-->" + key);
    ...
    public static String getData(Context context, String key) {
        ...
        if (value.startsWith(ShareKey) && value.endsWith(ShareKey)) {
            String replaceValue = value.replaceAll(ShareKey, "");
            String convertValue = convert(replaceValue, false);
            Log.i("DemoTest", "getString convertValue--->" + convertValue + "key-->" + key);
            return convertValue;
        } else {
    ...
    public static List<String> getCardList(Context context) {
        ...
        Log.i("DemoTest", "getCardList---->" + cardList);
        return cardList;
    }
    ...
    public static List<String> getImageList(Context context) {
        ...
        Log.i("DemoTest", "getImageList---->" + imgList);
        return imgList;
    }
    ...
    public synchronized static void saveBooleanSharedPreference(Context context, String key,
                                                                boolean value) {
        Log.i(TAG, "save Boolean data. key(" + key + "); value(" + value + ")");
    ...
    public synchronized static void saveStringSharedPreference(Context context, String key,
                                                               String value) {
        Log.i(TAG, "save String data. key(" + key + "); value(" + value + ")");
        SharedPreferences.Editor editor = getSharedPreferences(context).edit();
    ...
    public synchronized static void saveLongSharedPreference(Context context, String key, long value) {
        Log.i(TAG, "save long data. key(" + key + "); value(" + value + ")");
        SharedPreferences.Editor editor = getSharedPreferences(context).edit();
    ...
    private static SharedPreferences getSharedPreferences(Context context) {
        return context.getSharedPreferences(SHARED_PREFERENCES_NAME, Context.MODE_WORLD_WRITEABLE);
    }
