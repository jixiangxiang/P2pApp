...
import cn.com.infohold.p2papp.common.gate.LogUtils;
...
//			XmlResourceParser mXmlResourceParser = mAssetManager.openXmlResourceParser("plist.xml");
    ...
    public static String getIntentGoodsDetailsAction(Context context){
        return getPapers(context, "intent_goods_detail", "constants");
    }
