 ...
 * Use the {@link PQuestFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PQuestFragment extends Fragment {
    ...
    public static PQuestFragment newInstance(String param1, String param2) {
        PQuestFragment fragment = new PQuestFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_pquest, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        questionBeans.add(new QuestionBean("是否可以提前收回本金？", "可以，持有90天后您可以通过债权的方式提前收回出借的资金"));
        questionBeans.add(new QuestionBean("是否可以提前收回本金？", "可以，持有90天后您可以通过债权的方式提前收回出借的资金"));
        questionBeans.add(new QuestionBean("是否可以提前收回本金？", "可以，持有90天后您可以通过债权的方式提前收回出借的资金"));
        questionBeans.add(new QuestionBean("是否可以提前收回本金？", "可以，持有90天后您可以通过债权的方式提前收回出借的资金"));
        questionBeans.add(new QuestionBean("是否可以提前收回本金？", "可以，持有90天后您可以通过债权的方式提前收回出借的资金"));
        ...
        questionBeans.add(new QuestionBean("是否可以提前收回本金？", "可以，持有90天后您可以通过债权的方式提前收回出借的资金"));
        questionBeans.add(new QuestionBean("是否可以提前收回本金？", "可以，持有90天后您可以通过债权的方式提前收回出借的资金"));
        baseAdapter = new EBaseAdapter(getActivity(), questionBeans, R.layout.invest_question_item,
    ...
    private void initialize(View view) {
        investRecord = (WrapScrollListView) view.findViewById(R.id.questionList);
    }
