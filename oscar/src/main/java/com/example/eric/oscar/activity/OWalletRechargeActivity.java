...
public class OWalletRechargeActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_owallet_recharge);
    }
    ...
    protected void initView() {
        ...
        request = new StringRequest(Request.Method.POST, ApiUtils.WALBAL, this, this) {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("sign", SPUtils.getString(OWalletRechargeActivity.this, "sign"));
                return map;
            }
        };
    ...
    public void onClick(View v) {
        if (v == bankSelect.getParent()) {
            ...
            bundle.putString("amt", rechargeMoney.getText().toString());
            bundle.putString("card", bankInfo.getCardNo());
            toActivity(OWalletRechargeConfirmActivity.class, bundle);
            this.finish();
        }
    }
