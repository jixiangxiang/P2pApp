...
public class OWithdrawRecordActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_owithdraw_record);
    }

    @Override
    protected void initView() {
        initialize();
        initTitleText(getString(R.string.title_activity_owithdrawn_record), BaseActivity.TITLE_CENTER);
        ...
        request = new StringRequest(Request.Method.POST, ApiUtils.WALREC, this, this) {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("sign", SPUtils.getString(OWithdrawRecordActivity.this, "sign"));
                return map;
            }
        };
